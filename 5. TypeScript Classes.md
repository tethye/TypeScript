...
Here, **username is just a constructor parameter — it is not stored as a class property.**

***So is public required?***

* **If you want the shortcut** → *yes, some modifier is required*

* **If you don’t use a modifier** → *it behaves like a normal parameter*
...
* All protected properties and methods. (🔒 Protected members are accessible inside the subclass, but not outside the class hierarchy.)
...
* **static** keyword must be placed after **Access modifiers**
Example
```ts
class Helpers {
